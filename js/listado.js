...
Listado.prototype.buscarRestaurante = function(id) {
    var restaurante = this.restaurantes.find(restaurante => restaurante.id == id);
...
Listado.prototype.eliminarElementosRepetidos = function(array){
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    var ciudadesFiltradas = this.eliminarElementosRepetidos(ciudades);
...
Listado.prototype.obtenerRubros = function() {
    ...
    var rubrosFiltrados = this.eliminarElementosRepetidos(rubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    this.restaurantes.map(restaurante => arregloHorarios.push(restaurante.horarios));
    ...
    var horariosFiltrados = this.eliminarElementosRepetidos(horarios);
...
var listadoDeRestaurantes = [
    ...
    new Restaurant(25, "Lucy Cosas Ricas", "Desayuno", "Cordoba", ["13:00", "15:30", "18:00"], "../img/desayuno5.jpg", [])
];
